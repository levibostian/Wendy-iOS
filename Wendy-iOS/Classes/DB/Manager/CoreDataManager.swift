 ...
 internal class CoreDataManager {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        let container = NSPersistentContainer(name: "Wendy", managedObjectModel: model)
...
////        let modelURL = Bundle.main.url(forResource: "Wendy", withExtension: "momd")!
//        let modelURL = Bundle.urlForWendyFramework().url(forResource: "Wendy", withExtension: "momd")!
//        return NSManagedObjectModel(contentsOf: modelURL)!
//
////
////        //    NSURL *modelURL = [[NSBundle bundleWithIdentifier:@"kemmitorz.myFramework"] URLForResource:@"Database" withExtension:@"momd"];
////        Bundle.allFrameworks["Wendy"]
...
//         error conditions that could cause the creation of the store to fail.
//         */
//        let container = NSPersistentContainer(name: "Wendy")
